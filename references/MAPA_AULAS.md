...
| [ETL Pipelines](https://github.com/AnaRaquelCafe/POSTECH_AI_SCIENTIST/tree/main/Fase%202/ETL%20Pipelines) | Pandas/PySpark ETL; Kafka produce/consume; **AWS Glue** `etl-bronze/silver/gold` com buckets SOR/SOT/SPEC | `pipelines/batch/glue_jobs_template.py`, `pipelines/streaming/`, `pipelines/cloud/` |
